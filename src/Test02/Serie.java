...
public class Serie implements Entregable{
	...
	/* Método para comparar el número de temporadas y indicar si tiene más, las mismas o menos */
	...
	/* Método que reescribe y muestra la información de cada atributo de la serie*/
	@Override
